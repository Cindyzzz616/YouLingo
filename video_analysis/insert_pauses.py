...
# TODO write a method to insert pauses at constituent boundaries
...
def insert_pauses_between_sentences(video: Video, pause_duration: float):
    """
    Insert a pause of a custom duration between sentences. This works as intended.
    """
    clip = VideoFileClip(video.path)
...
def insert_pauses_at_punctuations(video: Video, pause_duration: float):
    """
    This doesn't work super well - word-level timestamps from Whisper aren't very precise.
    TODO is there a way to modify the decimal precision of the timestamps?
    """
