...
class DrtParser(LogicParser):
    ...
    def handle(self, tok, context): # -> NegatedExpression | LambdaExpression | DRS | AndExpression | IffExpression | ImpExpression | OrExpression | DrtProposition | ApplicationExpression | IndividualVariableExpression | FunctionVariableExpression | EventVariableExpression | ConstantExpression | None:
