...
def rebuild_tree(orig_tree): # -> tuple[Any, list[tuple[Any, list[tuple[Any, list[Any]]]]]]:
    ...

def get_relations_data(word, synset): # -> tuple[tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[tuple[Any, list[tuple[Any, list[Any]]]]]], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[Any] | Any], tuple[int, str, list[Any] | Any]] | tuple[tuple[int, str, list[Any] | Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[tuple[Any, list[tuple[Any, list[Any]]]]]], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[Any] | Any]] | tuple[tuple[int, str, list[Any] | Any], tuple[int, str, Any], tuple[int, str, list[Any] | Any], tuple[int, str, Any], tuple[int, str, Any]] | tuple[tuple[int, str, list[Any] | Any]]:
    """
