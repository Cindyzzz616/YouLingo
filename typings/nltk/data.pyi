...
class FileSystemPathPointer(PathPointer, str):
    ...
    def open(self, encoding=...): # -> SeekableUnicodeStreamReader | BufferedReader[_BufferedReaderStream]:
        ...
...
def load(resource_url, format=..., cache=..., verbose=..., logic_parser=..., fstruct_reader=..., encoding=...): # -> PunktTokenizer | Maxent_NE_Chunker | ClassifierBasedPOSTagger | PerceptronTagger | _UrlopenRet | CFG | PCFG | FeatureGrammar | list[Any] | Valuation:
    """
