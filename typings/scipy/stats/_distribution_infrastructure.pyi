...
class _RealParameter(_Parameter):
    ...
    """
    def validate(self, arr, parameter_values): # -> tuple[ndarray[_Shape, dtype[Any]] | ndarray[_Shape, dtype[float64]], dtype[Any] | dtype[float64], Any]:
...
class UnivariateDistribution(_ProbabilityDistribution):
    ...
    @property
    def tol(self): # -> ndarray[_Shape, dtype[Any]]:
        r"""positive float:
        The desired relative tolerance of calculations. Left unspecified,
        calculations may be faster; when provided, calculations may be
        more likely to meet the desired accuracy.
    ...
    def support(self): # -> tuple[ndarray[_Shape, dtype[float64]] | ndarray[_Shape, dtype[Any]], ndarray[_Shape, dtype[float64]] | ndarray[_Shape, dtype[Any]]]:
        ...
    ...
    @_set_invalid_nan_property
    def entropy(self, *, method=...): # -> Callable[..., Any] | Callable[..., _Array[tuple[int, ...], float64 | Any] | Any | ndarray[_Shape, dtype[Any]]]:
        ...
    
    @_set_invalid_nan_property
    def median(self, *, method=...): # -> Callable[..., Any] | Callable[..., Callable[..., Any] | Callable[..., ndarray[_Shape, dtype[Any]] | Any]]:
        ...
    
    @_set_invalid_nan_property
    def mode(self, *, method=...): # -> Callable[..., Any] | Callable[..., _Array[tuple[int, ...], float64 | Any] | ndarray[_Shape, dtype[Any]]]:
        ...
    ...
    def logcdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_Shape, dtype[Any]] | Any] | Callable[..., _Array[tuple[int, ...], float64 | Any] | Any | ndarray[_Shape, dtype[Any]]]:
        ...
    
    def cdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_Shape, dtype[Any]] | Any] | Callable[..., _Array[tuple[int, ...], float64 | Any] | Any | ndarray[_Shape, dtype[Any]]] | Callable[..., ndarray[_Shape, dtype[Any]]]:
        ...
    
    def logccdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., tuple[Any, Any] | Any]:
        ...
    
    def ccdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_Shape, dtype[Any]] | Any] | Callable[..., _Array[tuple[int, ...], float64 | Any] | Any | ndarray[_Shape, dtype[Any]]]:
        ...
    
    @_set_invalid_nan
    def ilogcdf(self, logp, /, *, method=...): # -> Callable[..., Any] | Callable[..., Callable[..., Any] | Callable[..., Callable[..., Any] | Any]]:
        ...
    
    @_set_invalid_nan
    def icdf(self, p, /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_Shape, dtype[Any]] | Any]:
        ...
    
    @_set_invalid_nan
    def ilogccdf(self, logp, /, *, method=...): # -> Callable[..., Any] | Callable[..., Callable[..., Any] | Any]:
        ...
    
    @_set_invalid_nan
    def iccdf(self, p, /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_Shape, dtype[Any]] | Any]:
        ...
...
class Mixture(_ProbabilityDistribution):
    ...
    def support(self): # -> tuple[ndarray[tuple[int, ...], dtype[Any]], ndarray[tuple[int, ...], dtype[Any]]]:
        ...
    
    def logentropy(self, *, method=...): # -> ndarray[_Shape, dtype[Any]]:
        ...
    ...
    def mean(self, *, method=...): # -> ndarray[_Shape, dtype[Any]] | Any:
        ...
    
    def variance(self, *, method=...): # -> ndarray[_Shape, dtype[Any]]:
        ...
    ...
    def pdf(self, x, /, *, method=...): # -> ndarray[_Shape, dtype[Any]] | Any:
        ...
    
    def logpdf(self, x, /, *, method=...): # -> ndarray[_Shape, dtype[Any]]:
        ...
    
    def pmf(self, x, /, *, method=...): # -> ndarray[_Shape, dtype[Any]] | Any:
        ...
    
    def logpmf(self, x, /, *, method=...): # -> ndarray[_Shape, dtype[Any]]:
        ...
    
    def cdf(self, x, y=..., /, *, method=...): # -> ndarray[_Shape, dtype[Any]] | Any:
        ...
    
    def logcdf(self, x, y=..., /, *, method=...): # -> ndarray[_Shape, dtype[Any]]:
        ...
    
    def ccdf(self, x, y=..., /, *, method=...): # -> ndarray[_Shape, dtype[Any]] | Any:
        ...
    
    def logccdf(self, x, y=..., /, *, method=...): # -> ndarray[_Shape, dtype[Any]]:
        ...
    ...
    def sample(self, shape=..., *, rng=..., method=...):
        ...
