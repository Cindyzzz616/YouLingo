...
class gaussian_kde:
    ...
    @property
    def inv_cov(self): # -> NDArray[float64] | NDArray[inexact[Any, float | complex]] | Any | NDArray[complex128]:
        ...
    ...
    @property
    def weights(self): # -> ndarray[_Shape, dtype[Any]] | Any | NDArray[float64]:
        ...
