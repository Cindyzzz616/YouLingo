...
def expm(A): # -> ndarray[_Shape, dtype[Any]] | ndarray[Any, dtype[Any]] | NDArray[Any] | csc_array | Any | NDArray[float64] | _NotImplementedType:
    """
...
def matrix_power(A, power): # -> coo_array | coo_matrix | dia_array | Any | dia_matrix | _NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int, int], Any] | NDArray[Any] | matrix[Any, Any]:
    """
