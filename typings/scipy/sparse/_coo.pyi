...
class _coo_base(_data_matrix, _minmax_mixin):
    ...
    @property
    def row(self): # -> NDArray[signedinteger[_32Bit] | signedinteger[_64Bit]] | ndarray[_Shape, dtype[signedinteger[_64Bit]]] | NDArray[Any] | NDArray[intp]:
        ...
    ...
    def diagonal(self, k=...): # -> ndarray[tuple[int], dtype[float64 | int_ | numpy.bool[builtins.bool]]]:
        ...
