...
def eig_banded(a_band, lower=..., eigvals_only=..., overwrite_a_band=..., select=..., select_range=..., max_ev=..., check_finite=...): # -> NDArray[float64] | NDArray[Any] | tuple[NDArray[float64] | NDArray[Any], NDArray[float64] | NDArray[Any]] | tuple[Any, Any]:
    """
...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> ndarray[tuple[int, int], dtype[float64]] | tuple[ndarray[tuple[int, int], dtype[float64]], Any] | tuple[NDArray[float64] | NDArray[Any], NDArray[float64]] | NDArray[float64] | NDArray[Any] | tuple[NDArray[Any], Any]:
    """
...
def cdf2rdf(w, v): # -> tuple[ndarray[tuple[int, ...], dtype[float64]], Any]:
    """
