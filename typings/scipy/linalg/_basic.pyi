...
@_apply_over_batch(('a', 2), ('b', '1|2'))
def solve_triangular(a, b, trans=..., lower=..., unit_diagonal=..., overwrite_b=..., check_finite=...): # -> NDArray[float64] | NDArray[Any]:
    """
...
def solve_toeplitz(c_or_cr, b, check_finite=...): # -> ndarray[tuple[int, int], dtype[complex128 | float64]] | NDArray[complex128 | float64] | ndarray[_Shape, dtype[Any]]:
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...): # -> NDArray[complex128 | float64] | ndarray[_Shape, dtype[float64]] | NDArray[complex128]:
...
def det(a, overwrite_a=..., check_finite=...): # -> complex128 | float64 | _Array[tuple[int, ...], float64 | complex128] | ndarray[_Shape, dtype[Any]]:
    """
...
@_apply_over_batch(('a', 2), ('b', '1|2'))
def lstsq(a, b, cond=..., overwrite_a=..., overwrite_b=..., check_finite=..., lapack_driver=...): # -> tuple[_Array[tuple[int, ...], floating[_64Bit]], Any | _Array[tuple[int], float64], Literal[0], _Array[tuple[int], float64]] | tuple[Any, Any | NDArray[Any], Any, Any] | tuple[Any, NDArray[Any], Any, None] | None:
    """
...
@_apply_over_batch(('a', 2))
def pinv(a, *, atol=..., rtol=..., return_rank=..., check_finite=...): # -> tuple[NDArray[float64] | NDArray[Any] | Any, numpy.bool[builtins.bool]] | NDArray[float64] | NDArray[Any] | Any:
    """
...
@_apply_over_batch(('A', 2))
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[NDArray[float64], tuple[NDArray[float64], _Array1D[signedinteger[Any]]]] | tuple[NDArray[float64], NDArray[float64]] | tuple[Any, tuple[NDArray[Any], _Array1D[signedinteger[Any]]]] | tuple[Any, ndarray[_Shape, dtype[Any]]]:
    """
