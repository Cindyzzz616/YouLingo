...
def expm(A): # -> NDArray[Any] | ndarray[tuple[int, ...], dtype[float64] | dtype[floating[_32Bit]]]:
...
@_apply_over_batch(('A', 2))
def cosm(A): # -> NDArray[float64] | NDArray[floating[Any]] | ndarray[tuple[int, ...], dtype[float64 | floating[_32Bit]]]:
    """
...
@_apply_over_batch(('A', 2))
def sinm(A): # -> NDArray[complex128] | NDArray[complexfloating[Any, Any]] | ndarray[tuple[int, ...], dtype[float64 | floating[_32Bit]]]:
    """
...
@_apply_over_batch(('A', 2))
def coshm(A): # -> ndarray[_Shape, dtype[float64]] | ndarray[_Shape, dtype[floating[Any]]]:
    """
...
@_apply_over_batch(('A', 2))
def sinhm(A): # -> ndarray[_Shape, dtype[float64]] | ndarray[_Shape, dtype[floating[Any]]]:
    """
...
def khatri_rao(a, b): # -> NDArray[Any]:
    r"""
    Khatri-rao product
